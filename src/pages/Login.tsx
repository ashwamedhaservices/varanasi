...
const Login = () => {
    ...
    return (
        <Box display='flex' justifyContent='center' flexDirection='column' alignItems='center' height='100vh' gap='2em'>
            <Logo height='100px' width='100px' />
            <Text fontSize='1.5rem' fontWeight={700}>Ashwamedha</Text>
            <Text>Sign in to your account to continue learning</Text>
            <Box bg='blackAlpha.50' borderRadius='0.5em' display='flex' flexDirection='column' gap='2em' alignItems='center' width='50%' padding='2em'>
                
                <Input placeholder='Username' value={formData.username} width='100%' name='username' onChange={handleChange} bgColor='white' />
                <Input placeholder='Password' value={formData.password} type='password' name='password' onChange={handleChange}  bgColor='white' />
